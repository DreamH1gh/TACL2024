...
def get_mapping(flag=True):
    ...
    value2slot = torch.load(os.path.join(root_path, 'value_dict.pt'))
    ...
    return label0_list, label1_list, label2_list, label0_label2id, label1_label2id, label2_label2id, label0_to_label1_mapping, label1_to_label2_mapping, label1_to_label0_mapping, label2_to_label1_mapping
...
if __name__ == "__main__":
    with open(os.path.join(root_path, "dbp_test.json"), 'r', encoding='utf-8') as fp:
        lines = [line.strip() for line in list(fp)]
